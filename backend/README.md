...
## Project Structure
    ...
    ├── testapiautoteammemb_82484  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_82484`
...
2. Clone this repo and `cd testapiautoteammemb_82484`
